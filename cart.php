            ...
            <div class="card p-3">
                ...
                <div class="cart-empty card-body text-center">
                    <div>
                        <svg width="90" height="90" viewBox="0 0 24 24" fill="none">
                            <path d="M3 3h2l.4 2M7 13h10l4-8H5.4" stroke="#6c757d" stroke-width="1.5"
                ...
                <form id="cartForm" method="post">
                    ...
                    <div class="d-flex align-items-start gap-2 gap-lg-3 p-3 rounded mb-2 product-row">
                        <img class="product-img flex-shrink-0" src="uploads/<?php echo $img; ?>"
                            alt="<?php echo $name; ?>">
                        <div class="flex-grow-1 min-w-0">
                            <div class="d-flex justify-content-between align-items-start gap-2 flex-wrap">
                                <div class="min-w-0">
                                    <a class="fw-semibold product-name d-inline-block"
                                        href="product-detail.php?id=<?php echo $id; ?>">
                                        <?php echo $name; ?>
                                    </a>
                            ...
                            <div class="d-flex align-items-center gap-2 mt-2 mt-lg-3 cart-bottom-row">
                                <div class="input-group cart-qty-group">
                                    <button type="button" class="btn btn-outline-secondary btn-sm qty-btn dec"
                                        onclick="handleQtyChange(<?php echo $id; ?>, -1)"><i
                                            class="fa fa-minus"></i></button><input type="number"
                                        class="form-control form-ctrl-qty form-control-sm text-center qty-input"
                                        name="qty[<?php echo $id; ?>]" value="<?php echo $qty; ?>" min="1" max="100"
                                        inputmode="numeric" autocomplete="off">
                                    <button type="button" class="btn btn-outline-secondary btn-sm qty-btn inc"
                                        onclick="handleQtyChange(<?php echo $id; ?>, 1)"><i
                        ...
                        <div class="cart-remove flex-shrink-0">
                            <a href="cart.php?remove=<?php echo $id; ?>" class="btn btn-light btn-sm remove-btn"
                                title="Xóa"><i class="fa fa-trash text-danger"></i></a>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </form>
        ...
        <div class="col-lg-4">
            <div class="card p-3 rounded-soft">
                ...
                <div class="d-grid mb-2">
                    <?php if (empty($cart)): ?>
                    <button type="button" class="primary-btn d-flex justify-content-center align-items-center disabled"
                        disabled>
                        Tiến hành thanh toán
                    </button>
                    <div class="small text-danger mt-2">Giỏ hàng trống. Vui lòng thêm sản phẩm trước khi tiếp
                        tục.</div>
                    <?php else: ?>
                    <a href="checkout.php" class="primary-btn d-flex justify-content-center align-items-center"
